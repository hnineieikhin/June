...
using June2026WebApi.Models;
using Microsoft.AspNetCore.Http;
using Microsoft.AspNetCore.Mvc;

namespace June2026WebApi.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        //one endpoint,one request model, one response model
        [HttpPost]
        public IActionResult CreateUser([FromBody] UserCreateRequestModel requestModel)//FromBody is optional, cause it is deafult
        {
        ...
        public IActionResult PatchUser(int id, UserPatchRequestModel requestModel)
        {
            ...
            {
                item.Password = requestModel.Password!;//! prove that password is not null
            }
            int result = _db.SaveChanges();
